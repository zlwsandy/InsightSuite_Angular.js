...
describe('radio-button-editable directive', function () {
    var $rootScope,
        $compile,
        element;
    ...
    beforeEach(module('components/utils/radioButtonEditable.directive.html'));
    ...
    beforeEach(inject(function($compile, $rootScope) {
        ...
        element = angular.element(
            '<div radio-button-editable ng-model="model.value" editable-index="model.editableIndex" index="model.index" class="insight-setup-items-name">{{model.value}}</div>'
        );
