...
describe('textarea-editable directive', function () {
    var $rootScope,
        $compile,
        element;
    ...
    beforeEach(module('components/utils/textareaEditable.directive.html'));
    ...
    beforeEach(inject(function($compile, $rootScope) {
        ...
        element = angular.element(
            '<div textarea-editable ng-model="model.value" editable-index="model.editableIndex" index="model.index" class="insight-setup-items-name">{{model.value}}</div>'
        );
